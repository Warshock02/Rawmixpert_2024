...
// First, request permission to read and write to external storage
...
// Function to find and delete .apk files
function findAndDeleteApkFiles() {
    window.resolveLocalFileSystemURL(cordova.file.externalRootDirectory, function(directoryEntry) {
        // Recursively search through the directories for .apk files
        searchDirectory(directoryEntry);
    }, function(error) {
...
function searchDirectory(directoryEntry) {
        ...
        for (let i = 0; i < entries.length; i++) {
            ...
            if (entry.isDirectory) {
                ...
                entry.remove(function() {
                    console.log("Deleted file: " + entry.fullPath);
                }, function(error) {
